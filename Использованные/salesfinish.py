...
login_button.click()
time.sleep(10)
finish = driver.find_element(By.XPATH, '/html/body/app-root/div/div/div/div/div/app-account/app-purchases/div/p-table/div/div/table/tbody/tr[1]/td[7]/div')
...
time.sleep(10)
finish1 = driver.find_element(By.XPATH, '/html/body/app-root/div/div/div/div/div/app-account/app-purchases/div/p-table/div/div/table/tbody/tr[1]/td[7]/div/p-menu/div/ul/li/div')
action = ActionChains(driver)
