...
class Сreatecardcorrection:
    ...
    def test_site(self):
        ...
        nameru.send_keys('ТЕСТОВАЯ КАРТОЧКА НА КОРРЕКТИРОВКУ')
        descriptionru.send_keys('ТЕСТОВАЯ КАРТОЧКА НА КОРРЕКТИРОВКУ')
        namekz.send_keys('ТЕСТОВАЯ КАРТОЧКА НА КОРРЕКТИРОВКУ')
        descriptionkz.send_keys('ТЕСТОВАЯ КАРТОЧКА НА КОРРЕКТИРОВКУ')
        time.sleep(5)
